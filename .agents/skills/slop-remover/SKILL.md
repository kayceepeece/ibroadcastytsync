...
source: https://github.com/jeremylongshore/tons-of-skills-marketplace/blob/main/plugins/testing/code-cleanup/agents/slop-remover.md
---
...
4. **Serve as public API documentation** — docs on exported functions with non-obvious behavior
...
- **Mixed comments**: A doc block with some valuable and some slop entries — remove only the slop lines, keep the block structure and valuable entries intact.
